...
const Home = () => {
  ...
  useEffect(() => {
    fetch('https://scaler-support-center-backend-production.up.railway.app/api/articles')
      .then(res => res.json())
      .then(data => {
  ...
  const handleSendMessage = async (e) => {
    ...
    try {
      const res = await fetch('https://scaler-support-center-backend-production.up.railway.app/api/chat', {
        method: 'POST',
    ...
    <div className="home-container">
      ...
      <section className="hero-section">
        ...
        <div className="popular-searches">
          <span>Popular:</span>
          <div className="search-chip" onClick={() => { setSearchQuery('EMI & Payments'); setIsSearchFocused(true); }}>EMI & Payments</div>
          <div className="search-chip" onClick={() => { setSearchQuery('Certificate download'); setIsSearchFocused(true); }}>Certificate download</div>
          <div className="search-chip" onClick={() => { setSearchQuery('Reset password'); setIsSearchFocused(true); }}>Reset password</div>
          <div className="search-chip" onClick={() => { setSearchQuery('Session scheduling'); setIsSearchFocused(true); }}>Session scheduling</div>
        </div>
        ...
        <div className="cta-section">
          ...
          <div className="unified-cta-card">
            <div className="cta-content-wrapper">
              ...
              <p>Chat with our AI-powered support assistant for instant help with your queries.</p>
            </div>
          ...
          <div className="unified-cta-card">
            <div className="cta-content-wrapper">
              ...
              <p>Please reach out to support first via chat. If your issue is not resolved or no response is received within 24 hours.</p>
            </div>
            <button className="chat-support-btn unified-secondary-btn" onClick={() => { setShowEscalationModal(true); setEscalationStep('guidance'); }}>
              Raise an Escalation
            </button>
          </div>
        </div>
