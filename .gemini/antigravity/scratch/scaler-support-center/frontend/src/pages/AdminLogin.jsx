...
const AdminLogin = () => {
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      // Initiate Google OAuth flow (simulated for development)
      const result = await adminLogin('admin@scaler.com', 'google_oauth');
        ...
        <div className="login-form">
          ...
          <div style={{ 
            ...
            <p style={{ 
              ...
              Admin access is restricted to @scaler.com accounts only
            </p>
          </div>
