    ...
    <div className="login-container">
      <div className="login-card">
        <div className="login-header">
          ...
          <h2>Admin Login</h2>
          <p>Sign in securely with your @scaler.com Workspace</p>
        </div>
        ...
        <div className="login-form">
          ...
          <div style={{ marginTop: '20px' }}>
            <button 
              ...
              className="primary-login-btn google-oauth-btn" 
              style={{
                display: 'flex', 
                alignItems: 'center', 
            ...
            >
              {isLoading ? (
                <div className="loading-spinner" style={{ borderTopColor: '#3c4043' }}></div>
              ) : (
                <>
                  ...
                  <span style={{ fontWeight: '500', fontSize: '15px' }}>Sign in with Google</span>
                </>
              )}
            </button>
          </div>
